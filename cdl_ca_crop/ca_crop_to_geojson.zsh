...
SQL_CA_CROP="$(pwd)/ca_crop_to_geojson.sql"
CA_CROP_GEOJSON="${OUTPUT_DIR}/ca_crop_${YYYY}"
...
#OGR2OGR_CMD="ogr2ogr -f FlatGeoBuf ${CA_CROP_GEOJSON}.fgb -s_srs \"${OUTPUT_SRS}\" -t_srs \"${OUTPUT_SRS}\" -nln ca_crop_${YYYY} PG:\"${DB_CONN_STR}\" -sql @${SQL_CA_CROP}"
#echo $OGR2OGR_CMD
#eval "${OGR2OGR_CMD}"
